@echo off
title Gemini CLI Context Menu Uninstaller
cls
...
:: ============================================================================
echo Removing context menu entries from the Windows Registry...
REG DELETE "HKEY_CLASSES_ROOT\Directory\shell\OpenInGeminiCLI" /f >nul
REG DELETE "HKEY_CLASSES_ROOT\Directory\Background\shell\OpenInGeminiCLI" /f >nul
